...
WebUI.callTestCase(findTestCase('Test Reutilisable/Main/Lancer URL ANEF'), [('Profiles') : 'Usager', ('EnvExec') : EnvExec], 
...
if (GlobalVariable.StopTestCase == false) {
    ...
    if (GlobalVariable.StopTestCase == false) {
        ...
        WebUI.callTestCase(findTestCase('Test Reutilisable/DemandeOuRenouvelle_TitreSejour/FormulaireMotifDeLaDemande'), 
            [('TypeTitreDeSejour') : TypeTitreDeSejour, ('ChangementSituation') : ChangementSituation, ('Titre') : Titre], 
            FailureHandling.STOP_ON_FAILURE)
